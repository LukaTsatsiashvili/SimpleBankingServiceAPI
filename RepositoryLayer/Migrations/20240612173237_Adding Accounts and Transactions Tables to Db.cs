...
{
    /// <inheritdoc />
    public partial class AddingAccountsandTransactionsTablestoDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderAccountNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RecipientAccountNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.RecipientAccountNumber,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_RecipientAccountNumber",
                table: "Transactions",
